...
// class _MyAppState extends State<MyApp> {
  ...
  bootpayReqeustDataInit() {
    ...
    payload.webApplicationId = '64b5ea0200be04001d77a53a'; // web application id
    payload.androidApplicationId = '64b5ea0200be04001d77a53b'; // android application id
    payload.iosApplicationId = '64b5ea0200be04001d77a53c'; // ios application id
